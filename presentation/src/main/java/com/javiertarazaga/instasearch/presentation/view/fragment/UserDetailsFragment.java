...
import com.javiertarazaga.instasearch.presentation.presenter.UserDetailsPresenter;
import com.javiertarazaga.instasearch.presentation.view.UserDetailsView;
import com.javiertarazaga.instasearch.presentation.view.component.AutoLoadImageView;
...
public class UserDetailsFragment extends BaseFragment implements UserDetailsView {
  ...
  @Bind(com.javiertarazaga.instasearch.presentation.R.id.iv_cover) AutoLoadImageView iv_cover;
  @Bind(com.javiertarazaga.instasearch.presentation.R.id.tv_fullname) TextView tv_fullname;
  @Bind(com.javiertarazaga.instasearch.presentation.R.id.tv_email) TextView tv_email;
  @Bind(com.javiertarazaga.instasearch.presentation.R.id.tv_followers) TextView tv_followers;
  @Bind(com.javiertarazaga.instasearch.presentation.R.id.tv_description) TextView tv_description;
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    final View fragmentView = inflater.inflate(com.javiertarazaga.instasearch.presentation.R.layout.fragment_user_details, container, false);
  ...
  @OnClick(com.javiertarazaga.instasearch.presentation.R.id.bt_retry)
